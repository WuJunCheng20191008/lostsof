 ...
 * */
@Order(5)//注解来标识切面的优先级。i的值越小，优先级越高
@Aspect
@Component
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.demon.aop.controller..*.*(..))")
    public void webLog(){}
    ...
    public void doAfterReturning(Object ret){
        ...
        logger.info("SPENT TIME:"+ (System.currentTimeMillis()-startTime.get()));
    }
}
