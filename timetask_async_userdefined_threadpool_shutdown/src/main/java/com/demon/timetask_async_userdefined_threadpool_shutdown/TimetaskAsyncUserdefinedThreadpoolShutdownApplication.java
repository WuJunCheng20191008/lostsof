...
public class TimetaskAsyncUserdefinedThreadpoolShutdownApplication {

    public static void main(String[] args) {
        SpringApplication.run(TimetaskAsyncUserdefinedThreadpoolShutdownApplication.class, args);
    }
    @Configuration
    @EnableAsync
